...
ctypedef fused float_f:
    #float
    double
    
cdef float c    = 29979245800.0 #cm.s-1
cdef float k_B  = 1.380649e-23 #J.K-1
...
cimport crs_cpp
from crs_cpp cimport cpp_calc_matrix_fp64, simd_calc_matrix_fp64, cpp_mult1_fp64, cpp_mult2_fp64, simd_mult2_fp64


def add_flt(float a, float b):
    return crs_cpp.add_flt(a,b)
...
@cython.cdivision(True) #this causes trouble
